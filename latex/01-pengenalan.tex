...
\begin{figure}[htbp]
\centering 
\shadowimage[width=8cm]{../manuscript/images/Capture1-1}
...
\begin{figure}[htbp]
\centering
\shadowimage[width=8cm]{../manuscript/images/Capture1-2}
...
\begin{figure}[htbp]
\centering
\shadowimage[width=8cm]{../manuscript/images/Capture1-3}
...
\begin{figure}[htbp]
\centering
\shadowimage[width=8cm]{../manuscript/images/qt-downloads}
...
\begin{center}
	 \includegraphics[width=0.4\textwidth]{../manuscript/images/install-qt-1}
\end{center}
...
\begin{center}
	 \includegraphics[width=0.4\textwidth]{../manuscript/images/install-qt-2}
\end{center}
...
\begin{center}
	 \includegraphics[width=0.4\textwidth]{../manuscript/images/install-qt-3}
\end{center}
...
\begin{center}
	...
	\includegraphics[width=0.4\textwidth]{../manuscript/images/install-qt-4}
\end{center}
...
Creator}\label{program-console-pertama-dengan-qt-creator}
  ...
  \includegraphics[width=0.8\textwidth]{../manuscript/images/qt-console-aplication}
  ...
  \includegraphics[width=0.8\textwidth]{../manuscript/images/qt-console-aplication-2}
...
\includegraphics[width=0.8\textwidth]{../manuscript/images/qt-console-aplication-3}
...
\begin{figure}[htbp]
\centering
\shadowimage[width=8cm]{../manuscript/images/qt-console-aplication-4}
...
\includegraphics[width=0.8\textwidth]{../manuscript/images/qt-creator}
