...
\section{Polimorfisme (Polymorphism)}\label{sec-polymorphism}
...
\subsection{Perbedaan Tipe Data Standard dan Kelas}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-1.c++}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-3.c++}
\item
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-4.c++}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-5.c++}
\item
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-6.c++}
\item
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-7.c++}
\item
 Demikian juga pada daftar\_burung, yang pertama berisi objek Burung
 sedangkan yang kedua berisi Kuda\_terbang :

\lstinputlisting[language=c++]{../code/09-Polymorphism-code-8.c++}
\item
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-9.c++}
\item
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-10.c++}

Maka konstruktor default kelas banyak turunan (mutiple inheritance)
adalah :

\lstinputlisting[language=c++]{../code/09-Polymorphism-code-11.c++}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-13.c++}
\item
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-14.c++}

Maka kompile akan menampilkan pesan kesalahan :

\lstinputlisting[language=c++]{../code/09-Polymorphism-code-15.c++}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-16.c++}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-17.c++}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-18.c++}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-19.c++}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-20.c++}
\item
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-21.c++}
\end{itemize}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-22.c++}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-23.c++}
...
\lstinputlisting[language=c++]{../code/09-Polymorphism-code-24.c++}
\end{itemize}
