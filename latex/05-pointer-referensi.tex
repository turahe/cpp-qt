...
\begin{lstlisting}[language=c++, caption=Pointer dan Array, label=pointer-dan-array]
#include <QtCore/QCoreApplication>
#include <iostream>
int main(int argc, char *argv[])
{
...
\begin{lstlisting}[language=c++, caption=Mengalokasikan menggunakan dan mendelete Pointer, label=alokasi-menggunakan-delete-pointer]
#include <QtCore/QCoreApplication>
#include <iostream>
int main(int argc, char *argv[])
{
