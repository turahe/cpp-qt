...
\section{Pengenalan Bahasa C++}\label{pengenalan-bahasa-c}
...
\item
  ...
  Laboratories}\footnote{https://id.wikipedia.org/wiki/Bell\_Laboratories}, dinamakan
...
\item
  ...
  International Inc}\footnote{https://en.wikipedia.org/wiki/Borland}. mengembangkan kompiler C++ menjadi sebuah kompiler
  ...
  Berorientasi Obyek}\footnote{https://id.wikipedia.org/wiki/Pemrograman\_berorientasi\_objek}.
\end{itemize}
...
menggunakan MinGW\footnote{minGW adalah salah satu aplikasi yng
  ...
  gratis.} atau
\href{https://id.wikipedia.org/wiki/Microsoft_Visual_Studio_Express}{MSVC}\footnote{text}
...
dengan sistem cross-platform untuk mem-build secara automatis: qmake dan
CMake. Projek yang tidak menggunakan qmake atau CMake dapat
diimport-kan, dan Qt Creator dapat meng-ignore sistem build.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{images/capture1-1.png}
...
\subsection{UI Designer}\label{a-ui-designer}
...
\href{https://en.wikipedia.org/wiki/QML}{Qt Meta-Object Language (QML)}.
...
\subsection{Bahasa yang di dukung}\label{b-bahasa-yang-di-dukung}
...
\subsection{Platform}\label{c-platform}
...
\subsection{Tools}\label{d-tools}
...
repositories (\href{https://git-scm.com/}{Git}\footnote{text},
\href{https://subversion.apache.org/}{subversion}\footnote{text},
\href{https://www.perforce.com}{Perfoce}\footnote{text},
\href{www.nongnu.org/cvs/}{CVS}\footnote{text},
\href{https://www.mercurial-scm.org}{Mercurial}\footnote{text}).

\subsection{Debuggers}\label{e-debuggers}
...
QtQuick}\label{a-teknologi-user-interface-qtquick}
...
\subsection{Teknologi User Interface
QtWidget}\label{b-teknologi-user-interface-qtwidget}
...
\subsection{Teknologi User Interface
QtWebkit}\label{c-teknologi-user-interface-qtwebkit}
...
desktop seperti Html5 dan Css3?

Lalu kenapa tidak digunakan dalam pemrograman desktop? Ya, dengan
menggunakan User Interface QtWebkit ini anda bisa membuat sebuah desktop
...
unduh di \href{http://www.qt.io/download}{halaman} Qt cCreator.
...
14.04}\label{a.-install-qt-creator-di-ubuntu-14.04}
...
\paragraph{3. Install g++}\label{install-g}
...
\subsection{Install Qt di Windows}\label{b.-install-qt-di-windows}

Anda bisa mendownload di halaman downlod Qt creator dan memlilih versi
...
\subsection{Struktur Program C++}\label{struktur-program-c}
...
\tightlist
\item
  /* Komentar anda diletakkan di dalam ini bisa mengapit lebih dari satu
  baris */
\item
...
\subsubsection{Contoh 1. Structur program C++}
