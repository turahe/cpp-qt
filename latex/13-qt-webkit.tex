...
\item File $\rightarrow$ New File or Project $\rightarrow$ Other Project $\rightarrow$ Empty Qt Project
...
\item Add new $\rightarrow$ C++ $\rightarrow$ C++ Source File
...
\section{Browser dengan Kontrol - Versi 2}
...
\begin{enumerate}
\item Klik kanan pada nama project
\item Add new $\rightarrow$ Applications $\rightarrow$ Qt GUI Application
...
\item Go to slot $\rightarrow$ clicked()
\end{enumerate}
...
\begin{itemize}
\item \textbf{forwardButton} $\rightarrow$ clicked()
\item \textbf{refreshButton} $\rightarrow$ clicked()
\item \textbf{goButton} $\rightarrow$ clicked()
\item \textbf{urlEdit} $\rightarrow$ returnPressed()
\end{itemize}
