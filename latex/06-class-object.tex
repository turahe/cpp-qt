...
\begin{lstlisting}[language=c++, caption=Pembuatan class Sepeda, label=pembuatan-class-sepeda]
...
\begin{lstlisting}[language=c++, caption=Pembuatan obyek Sepeda]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Sepeda{
...
\begin{lstlisting}[language=c++, caption=Pembuatan Obyek Array Sepeda]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Sepeda{
...
\item
  Program diatas merupakan pengembangan lagi dari Contoh \ref{pembuatan-class-sepeda}.
\item
...
\begin{lstlisting}[language=c++, caption=Public pada member variabel]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Sepeda{
...
\begin{lstlisting}[language=c++, caption=Privat pada member variabel]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Sepeda{
...
\begin{lstlisting}[language=c++, caption=Member function dan implementasinya]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
...
\begin{lstlisting}[language=c++, caption=Penggunaan accessor dan mutator method]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Kucing{
...
\begin{lstlisting}[language=c++, caption=Menggunakan Constructor dan Destructor, label=menggunakan-Constructor-Destructor]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Kucing{
...
\begin{lstlisting}[language=c++, caption=Percobaan Menambah Constructor Method]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Kucing{
...
\begin{lstlisting}[language=c++, caption=Penggunaan Constructor dengan Nilai Default]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Buku{
...
\begin{lstlisting}[language=c++, caption=Memberi nilai default pada constructor]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Contoh{
...
\begin{lstlisting}[language=c++, caption=Penggunaan const method]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Kucing{
...
\begin{lstlisting}[language=c++, caption=Implementasi inline]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Manusia{
...
\begin{lstlisting}[language=c++, caption=Class Mobil dan Roda]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Roda{
...
\begin{lstlisting}[language=c++, caption=Class titik dan Garis, label=class-titik-garis]
#include <QtCore/QCoreApplication>
#include <iostream>
#include <math.h>
using namespace std;
