...
\begin{figure}[htbp]
\centering
\shadowimage[width=8cm]{../manuscript/images/capture3-1}
\label{gambar3-1}
...
\begin{figure}[htbp]
\centering
\shadowimage[width=8cm]{../manuscript/images/capture3-8}
...
\begin{figure}[htbp]
\centering
\shadowimage[width=8cm]{../manuscript/images/capture3-11}
...
\begin{figure}[htbp]
\centering
\shadowimage[width=8cm]{../manuscript/images/capture3-12}
\label{gambar3-3}
...
\includegraphics{../manuscript/images/warning} Akan terjadi ERROR!

\begin{figure}[htbp]
\centering
\shadowimage[width=8cm]{../manuscript/images/capture3-10}
...
\includegraphics{../manuscript/images/warning} Matriks yang jumlah datanya lebih akan menyebabkan ERROR


\begin{figure}
\centering
\shadowimage[width=8cm]{../manuscript/images/capture3-9}
\end{figure}
...
\begin{figure}[htbp]
\centering
\shadowimage[width=8cm]{../manuscript/images/capture2-7}
...
\begin{figure}[htbp]
\centering
\shadowimage[width=8cm]{../manuscript/images/capture3-6}
