...
\end{itemize}
\begin{quotation}
\includegraphics{images/tips.png}	\textbf{TIPS} 
...
\includegraphics{images/warning.PNG} Akan terjadi ERROR!
...
\includegraphics{images/warning.PNG} Matriks yang jumlah datanya lebih akan menyebabkan ERROR
...
\begin{lstlisting}[language=c++, caption=Membalik kata / kalimat, label=contoh3-29]
#include <QtCore/QCoreApplication>
#include <iostream>
#include <string>
#include <algorithm>
