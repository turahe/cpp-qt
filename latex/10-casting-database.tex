...
\begin{figure}
\centering
\shadowimage[width=8cm]{../manuscript/images/basis-data-qt}
...
\shadowimage[width=8cm]{../manuscript/images/phpmyadmin}
...
\shadowimage[width=8cm]{../manuscript/images/database-mhs}
...
\shadowimage[width=8cm]{../manuscript/images/sqlite-expert}
...
\shadowimage[width=8cm]{../manuscript/images/file-new-database}
