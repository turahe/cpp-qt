...
\section{Problema Pewarisan Tunggal (Single
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{images/capture8-1.png}
\caption{}
\end{figure}
...
\subsubsection*{Contoh 1. Meletakkan metode kelas turunan di kelas dasar.}
...
\subsubsection*{Contoh 2. Melakukan Down Casting.}
...
\subsubsection*{Contoh 3. Multiple Inheritance.}
...
\subsubsection*{Contoh 4. Konstruktor Kelas Multiple Inheritance.}
...
\subsubsection*{Contoh 5. Penurunan pada umumnya (Common Base Class).}
...
\subsubsection*{Contoh 6. Penurunan pada umumnya (Common Base Class).}
