...
\begin{figure}[htbp]
\centering 
\includegraphics[width=0.6\textwidth]{images/Capture1-1}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{images/Capture1-2}
\label{code-editor}
\caption{ Code Editor}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{images/Capture1-3}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{images/qt-downloads}
...
\begin{center}
	 \includegraphics[width=0.4\textwidth]{images/install-qt-1}
\end{center}
...
\begin{center}
	 \includegraphics[width=0.4\textwidth]{images/install-qt-2}
\end{center}
...
\begin{center}
	 \includegraphics[width=0.4\textwidth]{images/install-qt-3}
\end{center}
...
\begin{center}
	...
	\includegraphics[width=0.4\textwidth]{images/install-qt-4}
\end{center}
...
Creator}\label{program-console-pertama-dengan-qt-creator}
  ...
  \includegraphics[width=0.8\textwidth]{images/qt-console-aplication}
  ...
  \includegraphics[width=0.8\textwidth]{images/qt-console-aplication-2}
...
\includegraphics[width=0.8\textwidth]{images/qt-console-aplication-3}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{images/qt-console-aplication-4}
