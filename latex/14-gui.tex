...
\begin{enumerate}
	\item Buka Qt Creator dan buat proyek baru. Pilih Application \textgreater{} Qt Widget Application\footnote{gunakan pilihan ini untuk membuat applikasi GUI untuk proyek masa mendatang}.
		...
		\shadowimage[width=8cm]{../manuscript/images/Capture14-1}
		
		\item Beri nama Aplikasi yang akan di buat
		
		\shadowimage[width=8cm]{../manuscript/images/Capture14-2}
		...
		\shadowimage[width=8cm]{../manuscript/images/Capture14-3}
		
		\item  Pada Class Information berikan nama class yang di gunakan, disini penulis menggunakan guibaru.
		
		\shadowimage[width=8cm]{../manuscript/images/Capture14-4}
		...
		\shadowimage[width=8cm]{../manuscript/images/Capture14-5}
		
		\item Finish, maka tampilan Qt Creator Anda akan seperti berikut ini
		
		\shadowimage[width=8cm]{../manuscript/images/Capture14-6}
...
\begin{enumerate}
	...
	\shadowimage[width=8cm]{../manuscript/images/Capture14-7}
	...
	\shadowimage[width=8cm]{../manuscript/images/Capture14-8}
