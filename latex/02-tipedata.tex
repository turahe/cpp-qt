...
\begin{itemize}
	\item Tipe data dan Identifier\ref{tipe-data-dan-identifier}
	\item Tipe data bahasa C++\ref{tipe-data-bahasa-c}
	\item Variabel dan Konstanta\ref{variabel-dan-konstanta}
	\item Statement\pageref{statement}
	\item Operator dan\ref{} Ekspresi\pageref{operator-dan-ekspresi}
	\item Control Statement\pageref{control-statement}
\end{itemize}
