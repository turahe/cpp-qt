...
di memory komputer? Ilustrasi array satu dimensi pada memory komputer seperti gambar 3.1:
...
\subsection{Array 1 Dimensi}\label{a.-array-1-dimensi}
...
\subsubsection*{Contoh 1. Contoh Input dan Output Array}
...
\subsubsection*{Contoh 2. Contoh Manipulasi Array}
...
\subsubsection*{Contoh 3. Penanganan Batas Indeks Elemen Array}
...
\subsubsection*{Contoh 4. Inisialisasi Array dengan nilai 0}
...
\subsubsection*{Contoh 5. Inisialisasi Array dua nilai elemen pertama}
...
\subsubsection*{Contoh 6. Tanpa inisialisasi, array langsung ditampilkan}
...
\subsubsection*{Contoh 7. Penggunaan tipe data enum pada Array satu dimensi}
...
\subsubsection*{Contoh 8. Percobaan Penyalinan Array 1 dimensi}
...
\subsubsection*{Contoh 9. Penyalinan Array 1 dimensi dengan Perulangan}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{images/capture3-12.png}
...
E\textgreater{} Akan terjadi ERROR!
...
E\textgreater{} Matriks yang jumlah datanya lebih akan menyebabkan ERROR
...
\subsubsection*{Contoh 10. Deklarasi dan Menampilkan Array 2 Dimensi}
...
\subsubsection*{Contoh 11. Penyalinan Array 2 Dimensi ke Array 2 Dimensi lainnya}
...
\subsubsection*{Contoh 12. Penyalinan array 2 dimensi ke dalam array 1 dimensi.}
...
\subsubsection*{Contoh 13. Penggunaan karakter \textbackslash{0}}
...
\subsubsection*{Contoh 14. String tanpa karakter \textbackslash{0}}
...
\subsubsection*{Contoh 15. Mengisi Array of Character}
...
\subsubsection*{Contoh 16. Pengisian variabel array of character dengan maksimum jumlah
karakter.}
...
\subsubsection*{Contoh 17. Penggunaan fungsi strlen()}
...
\subsubsection*{Contoh 17. Penggunaan fungsi length pada tipe data string C++}
...
\subsubsection*{Contoh 18. Penggunaan fungsi strcpy()}
...
\subsubsection*{Contoh 19. Penggunaan fungsi strncpy()}
...
\subsubsection*{Contoh 20. Penggunaan fungsi strcat()}
...
\subsubsection*{Contoh 21. Penggunaan fungsi strcat()}
...
\subsubsection*{Contoh 22. Pembuatan variabel string C++, penyalinan string, dan
penggabungan string}
...
\begin{quotation}
	 ...
	 Class
	 string memiliki beberapa fitur / manfaat, yaitu: T\textgreater{}
	 T\textgreater{} - Mengurangi kesulitan dalam upaya penciptaan dan
	 memanipulasi string T\textgreater{} - Meningkatkan stabilitas aplikasi
	 yang sedang diprogram dalam pengelolaan dan alokasi memori internal
	 T\textgreater{} - Mudah dalam menyalin, memotong, menemukan, dan
	 penghapusan string T\textgreater{} - Memberikan kesempatan pada
	 programmer untuk lebih fokus pada pengembangan aplikasi daripada
	 kesulitan dalam manipulasi string
\end{quotation}


\subsubsection*{Contoh 23. Penggunaan class string untuk manipulasi dat}a
...
\subsubsection*{Contoh 24. Penggabungan string dengan menggunakan class string}
...
\subsubsection*{Contoh 25. Pengaksesan isi nilai class string}
...
\subsubsection*{Contoh 26. Menemukan substring pada sebuah string besar}
...
\subsubsection*{Contoh 27. Membalik kata / kalimat.}
