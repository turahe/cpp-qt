...
\item Jika angka $\leq$ 10, program tidak menampilkan apa-apa
\end{itemize}
\end{enumerate}
...
\item Jika angka $\leq$ 10, program menampilkan "kurang besar dari 10"
...
\subsection{Kata Kunci break dan continue}\label{kata-kunci-continue-dan-break}
...
\subsection{Kesalahan Umum yang Harus Dihindari}
