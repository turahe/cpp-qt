...
\begin{enumerate}
	\item Buka Qt Creator dan buat proyek baru. Pilih Application \textgreater{} Qt Widget Application\footnote{gunakan pilihan ini untuk membuat applikasi GUI untuk proyek masa mendatang}.
		...
		\shadowimage[width=8cm]{../manuscript/images/Capture14-1.PNG}
		
		\item Beri nama Aplikasi yang akan di buat
		
		\shadowimage[width=8cm]{../manuscript/images/Capture14-2.PNG}
		...
		\shadowimage[width=8cm]{../manuscript/images/Capture14-3.PNG}
		
		\item  Pada Class Information berikan nama class yang di gunakan, disini penulis menggunakan guibaru.
		
		\shadowimage[width=8cm]{../manuscript/images/Capture14-4.PNG}
		...
		\shadowimage[width=8cm]{../manuscript/images/Capture14-5.PNG}
		
		\item Finish, maka tampilan Qt Creator Anda akan seperti berikut ini
		
		\shadowimage[width=8cm]{../manuscript/images/Capture14-6.PNG}
...
\begin{enumerate}
	...
	\shadowimage[width=8cm]{../manuscript/images/Capture14-7.PNG}
	...
	\shadowimage[width=8cm]{../manuscript/images/Capture14-8.PNG}
