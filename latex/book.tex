...
% pengenalan, tipe data, control statement, array, string, 
% fungsi, pointer, dan referensi
%----------------------------------------------	
	\part{Dasar Pemrograman C++}\label{part-dasar}
%-------------------------------------------------
\input{1-dasar}
%------------------------------------------------	
	\chapter{Pengenalan C++ dan Qt Creator}\label{pengenalan}
	\input{01-pengenalan}
	
	\chapter{Tipe Data, Identifier dan Operator}\label{tipe-data}
	\input{02-tipedata}
	
	\chapter{Control Statement}\label{control-statement}
...
%--------------------------------------------------------
% Bagian OOP mempelajari tentang class, objek, inheritance,
% operator overloading, polymorphism, casting, dan database
%--------------------------------------------------------------
	\part{Pemrograman Berorientasi Objek}\label{part-oop}
%-------------------------------------------------
\input{2-oop}
%------------------------------------------------	
	...
	\chapter{Operator Overloading}\label{operator-overloading}
	\input{08-operator}
	
	\chapter{Polymorphism}\label{polymorphism}
	\input{09-Polymorphism}

	\chapter{Design Patterns}\label{design-patterns}
	\input{11-design-patterns}

	\chapter{Casting dan Database}\label{casting-dan-database}
	\input{10-casting-database}

%-------------------------------------------
% mempelajari tentang Qt Library dan komponen-komponennya
%----------------------------------- 	
	\part{Qt Library dan Komponen}\label{part-qt-library}
%-------------------------------------------------
\input{3-interface}
%------------------------------------------------	
	\chapter{Qt Library}\label{qt-library}
	\input{11-library}

	\chapter{File, Stream, dan XML}\label{file-stream-dan-xml}
	\input{12-file-stream-xml}

	\chapter{Qt WebKit}\label{qt-webkit}
	\input{13-qt-webkit}	

%-------------------------------------------
% mempelajari tentang antarmuka pengguna (GUI)
%----------------------------------- 	
	\part{Antarmuka Pengguna}\label{part-interface}
%-------------------------------------------------
\input{4-gui-intro}
%------------------------------------------------
	\chapter{GUI dengan Qt}\label{gui}
	\input{14-gui}
	
	\appendix

%-------------------------------------------------------------
% Bagian Lampiran berisi tentang index dan bibliography
%------------------------------------------------------------
	\backmatter
	\part{Lampiran}\label{part-lampiran}	

	\chapter{Contoh Program}
	\input{contoh}
	\printindex
