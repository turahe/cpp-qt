...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\linewidth, height=0.5\textheight]{../manuscript/images/capture3-11.PNG}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\linewidth, height=0.3\textheight]{../manuscript/images/capture3-12.PNG}
\label{gambar3-3}
