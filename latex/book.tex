...
%frame=shadowbox,
	...
	basicstyle=\ttfamily,
	numbers=left,
	emph={QDebug,iostream,QtCore,QCoreApplication,QtSql,QtDebug,string,QDomDocument,algorithm,QTextStream,QFile,QDomElement,QDomText,QDataStream,QList,QColor},
...
\lfoot{\includegraphics{images/logo-qt}} % [11]
...
\begin{document}
	...
	\includegraphics[width=0.2\textwidth]{images/cc-by-nc}
