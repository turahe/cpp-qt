...
\begin{lstlisting}[language=c++, caption=Menggunakan Binary Addition Operator, label=contoh8-4]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Kalender
...
\begin{lstlisting}[language=c++, caption=Overloading Comparison Operator (Equality dan Inequality, label=contoh8-6]
#include <QtCore/QCoreApplication>
#include <iostream>
using namespace std;
class Kalender
